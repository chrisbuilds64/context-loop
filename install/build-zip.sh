...
echo "  - unzip the Claude Code one and confirm pack/.claude/skills holds all six skills"
echo "  - confirm 'Install Context Loop.command' is still executable after unzipping"
echo "  - unzip the app one and confirm loop/ holds six procedures and no .claude/ came along"
